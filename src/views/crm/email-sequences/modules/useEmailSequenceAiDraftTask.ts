...
interface UseEmailSequenceAiDraftTaskOptions {
  checkedRows: ComputedRef<Api.Crm.SequenceReviewItem[]>;
  clearSelection: () => void;
  loadSequences: () => Promise<void>;
}

/** Manage CRM batch AI draft task lifecycle and live progress polling. */
export function useEmailSequenceAiDraftTask(options: UseEmailSequenceAiDraftTaskOptions) {

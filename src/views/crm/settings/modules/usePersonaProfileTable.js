...
export function usePersonaProfileTable() {
  ...
  const operatingPersonaProfileId = shallowRef(null);
  const editingPersonaProfileId = shallowRef(null);
  ...
  const filterModel = reactive(createDefaultPersonaProfileFilterModel());
  const formModel = reactive(createDefaultPersonaProfileForm());
  onMounted(() => {
  ...
  async function handleArchivePersonaProfile(record) {
  ...
  async function handleSetDefaultPersonaProfile(record) {

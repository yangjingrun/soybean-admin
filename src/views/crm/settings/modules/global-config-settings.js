...
export function createDefaultGlobalConfigForm() {
  return {
...
export function createDefaultSendPreferenceForm() {
  return {
    dailySendLimit: 50,
...
export function createDefaultFollowUpDelayDays() {
  return {
    step2Days: 3,
    step3Days: 7,
    step4Days: 14,
...
export function createDefaultSendWindow() {
  return {
    startMinute: 9 * 60,
    endMinute: 12 * 60
  };
...
export function createDefaultSendWindows() {
...
export function isValidEmailVerificationCooldownDays(value) {
...
export function isValidSendWindows(value) {
  return (
    value.length > 0 &&
    value.every(
      window =>

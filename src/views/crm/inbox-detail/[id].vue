...
import InboxThreadDetailPanel from '../inbox/modules/InboxThreadDetailPanel.vue';
import { useInboxThreadDetail } from '../inbox/modules/shared/useInboxThreadDetail';

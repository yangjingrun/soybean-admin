...
function createWorkbenchOverview(
  overrides: Omit<Partial<Api.Crm.WorkbenchOverview>, 'today' | 'yesterday' | 'runningTasks'> & {
    today?: Partial<Api.Crm.WorkbenchTodayStats>;
    yesterday?: Partial<Api.Crm.WorkbenchYesterdayStats>;
    runningTasks?: Array<Partial<Api.Crm.WorkbenchRunningTask>>;
  } = {}
): Api.Crm.WorkbenchOverview {
  return {

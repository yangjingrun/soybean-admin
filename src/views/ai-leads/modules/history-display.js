...
export function formatHistoryTargetRegions(regions) {
...
export function formatHistorySubject(plan) {
...
export function formatHistorySubjectTokens(plan) {
  return [
...
function resolveTargetRegionName(region) {
...
function resolveProductCategory(plan) {
...
function resolveCustomerTypes(plan) {
